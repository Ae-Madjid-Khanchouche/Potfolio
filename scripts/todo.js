...
function createTodoItem(data) {
    ...
    data.forEach(item => {
        ...
        // Append SVG container to the main container
        todoItemDiv.appendChild(svgContainer);
        toDoList.appendChild(todoItemDiv); // You can change 'document.body' to append it to a specific element
    })
    ...
    // Append the main container to the document body or a specific element
}
